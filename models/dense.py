...
def densenet201(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = DenseNet(num_init_features=64, growth_rate=32, block_config=(3, 4, 4, 5),
                     **kwargs)
    if pretrained:
        model_dict = model.state_dict()
...
class DenseNet(nn.Module):
    ...
    """
    def __init__(self, growth_rate=32, block_config=(3, 3, 24, 16),
                 num_init_features=64, bn_size=4, drop_rate=0, fc_layer1=1024, fc_layer2=128, global_pooling_size=(7,7)):
