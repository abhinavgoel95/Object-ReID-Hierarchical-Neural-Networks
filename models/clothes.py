...
__all__ = ['DenseNet', 'clothes_densenet201',]


def clothes_densenet201(pretrained=False, **kwargs):
    ...
    """
    model = DenseNet(num_init_features=160, growth_rate=32, block_config=(3, 12, 48, 32),
                    **kwargs)
    return model
