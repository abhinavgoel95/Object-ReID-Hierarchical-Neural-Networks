...
__all__ = ['DenseNet', 'gender_densenet201',]


def gender_densenet201(pretrained=False, **kwargs):
    ...
    """
    model = DenseNet(num_init_features=64, growth_rate=32, block_config=(3, 12, 48, 32),
                    **kwargs)
    return model
